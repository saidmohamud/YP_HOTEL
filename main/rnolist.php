                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <div class="row"> <div  class="col-md-5"> <label class="col pull-left">ID:</label>     <input type="nomber" name="gid" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['gid']; ?>"><br></div>
                                                      <div class="col-md-5"><label class="col pull-left">Room Number:</label>  <input type="text" name="rno" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['rno']; ?>"><br></div></div>
                                                <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Floor:</label>     <input type="text" name="floor" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['floor']; ?>"><br></div>
                                                      <div class="col-md-5"><label class="col pull-left">Room Type:</label><input type="text" name="room_type" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['room_type']; ?>"><br></div></div>
                                                <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Room Status:</label> <input type="text" name="room_status" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['room_status']; ?>"><br></div>
                                                     <div class="col-md-5"><label class="col pull-left">Room Price:</label> <input type="text" name="room_price" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['room_price']; ?>"><br></div></div>
