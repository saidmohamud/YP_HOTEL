                                    ...
                                    <div class="modal-body">
                                               ...
                                               <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Room Number:</label>     <input type="text" name="rno" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['rno']; ?>"><br></div>
                                                ...
                                                <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Room Type:</label> <input type="text" name="rtype" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['rtype']; ?>"><br></div>
                                                    <div class="col-md-5"><label class="col pull-left">Checkin Date:</label>  <input type="text" name="gdate" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['gdate']; ?>"><br></div></div>
                                                    
                                                <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Checkout Date:</label>    <input type="text" name="bdate" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['bdate']; ?>"><br></div>
                                                     <div class="col-md-5"><label class="col pull-left">Days:</label>  <input type="text" name="quantity" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['quantity']; ?>"><br></div></div>
                                                    
                                               <div class="row"> <div  class="col-md-5"> <label class="col pull-left">Room Price:</label>     <input type="text" name="price" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['price']; ?>"><br></div>
                                                    <div class="col-md-5"><label class="col pull-left">Total:</label>  <input type="text" name="amount" id="#edit-<?php echo $row['gid']; ?>" class="form-control" value="<?php echo $row['amount']; ?>"><br></div></div>
